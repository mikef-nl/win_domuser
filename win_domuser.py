...
module: win_domuser
version_added: "1.7"
short_description: Manages domain Windows user accounts
description:
     - Manages domain Windows user accounts
...
options:
  ...
  ou:
    description:
      - Optionally set the user's OU (OU=UserOU,DC=test,DC=local format).
    required: false
    default: null
  update_password:
    description:
